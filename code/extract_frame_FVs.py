...
def main(args):
    ...
    extract_global.generateGlobalFeatureFrame(videosearch_dir, output_dir, config.DATASET_DIR, joint_index_name, args.gaussians, args.sift_mode, args.num_threads)
